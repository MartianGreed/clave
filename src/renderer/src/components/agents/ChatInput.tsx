      ...
      <div className="flex flex-col gap-2 bg-surface-0 border border-border rounded-3xl px-4 py-3 focus-within:border-border transition-colors">
        ...
        <div className="flex items-center justify-end">
          <button
            ...
            className="flex items-center justify-center w-7 h-control-md rounded-full bg-action text-action-foreground hover:bg-action-hover disabled:opacity-30 disabled:hover:bg-action transition-colors flex-shrink-0"
          >
